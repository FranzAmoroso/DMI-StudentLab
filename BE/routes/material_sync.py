...
from services.material_download import (
    get_downloadable_material,
)

from services.material_sync import (
    build_material_sync_manifest,
)
...
MaterialDownloadSource = Literal[
    "public",
    "teacher",
    "group",
]
...
def material_sync_manifest(
    since: datetime | None = Query(
        default=None,
        description=(
            "Restituisce solo i materiali modificati dopo questo timestamp ISO-8601."
        ),
    ),
