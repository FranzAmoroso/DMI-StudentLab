...
import 'question_moderation_page.dart';
...
class TeacherSubjectToolsPage extends StatelessWidget {
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: _ToolCard(
                            ...
                            title: 'Revisioni domande',

                            description:
                                'Revisiona proposte degli studenti e domande segnalate con errori.',

                            actionLabel: 'Apri revisioni',

                            onTap: () => _openQuestionModeration(context),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: _ToolCard(
                            ...
                            onTap: () => _openAssignments(context),
                          ),
                        ),
  ...
  Future<void> _openQuestionModeration(BuildContext context) async {
    await Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (_) => QuestionModerationPage.teacher(
          department: departmentCode,
  ...
  Future<void> _openAssignments(BuildContext context) async {
  ...
  Future<void> _openMaterials(BuildContext context) async {
    ...
    await Navigator.of(context).push(
      MaterialPageRoute<void>(builder: (_) => const TeacherMaterialFormPage()),
    );
  }
}
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (subjectCode.trim().isNotEmpty) const SizedBox(height: 4),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, color: AppColors.skyBlue, size: 21),
