...
class _AppStartupGateState
  ...
  Future<void> _openUpdateUrl(
    ...
    if (updateUrl.isEmpty) {
      _showMessage(
        'Link di aggiornamento non ancora disponibile.',
      );
    ...
    if (uri == null) {
      _showMessage(
        'Link di aggiornamento non valido.',
      );
    ...
    if (!opened &&
        mounted) {
      _showMessage(
        'Impossibile aprire il link di aggiornamento.',
      );
    }
  }
