...
class AcademicPathsPage extends StatefulWidget {
  ...
  @override
  State<AcademicPathsPage> createState() =>
      _AcademicPathsPageState();
}

class _AcademicPathsPageState
    extends State<AcademicPathsPage> {
  ...
  Future<void> _setPrimary(
    ...
    try {
      ...
      _showMessage(
        'Percorso principale aggiornato.',
      );
    } catch (e) {
      if (!mounted) {
        return;
...
class AcademicPathEditorPage
  ...
  @override
  State<AcademicPathEditorPage>
      createState() =>
          _AcademicPathEditorPageState();
}

class _AcademicPathEditorPageState
    extends State<AcademicPathEditorPage> {
  ...
  Future<void> _save() async {
    ...
    if (
      ...
      _showMessage(
        'Seleziona ateneo, dipartimento e corso.',
      );
    ...
    if (
      ...
      _showMessage(
        'Solo un percorso attualmente frequentato può essere corrente.',
      );
