...
class TeacherHelpCard extends StatelessWidget {
  ...
  const TeacherHelpCard({super.key, required this.teacher});
  ...
  SocialAcademicPath? get _primaryAcademicPath {
    for (final SocialAcademicPath path in teacher.academicPaths) {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: AppColors.teacherIndigo.withValues(alpha: 0.30),
        ),
      ),
        ...
        children: [
          Row(
            children: [
              ...
              if (teacher.available) const _AvailableBadge(),
            ],
          ),
          ...
          Wrap(
            ...
            children: [
              ...
              if (teacher.availableForPrivateLessons)
                const _CapabilityChip(
          ...
          if (_helpSubjects.isNotEmpty) ...[
            ...
            ..._helpSubjects.map(
              (SocialSubject subject) => _TeacherSubject(
                subject: subject,

                type: _TeacherSubjectType.help,
              ),
            ),
          ],
          ...
          if (_privateLessonSubjects.isNotEmpty) ...[
            ...
            ..._privateLessonSubjects.map(
              (SocialSubject subject) => _TeacherSubject(
                ...
                type: _TeacherSubjectType.privateLesson,
              ),
            ),
          ],
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => ContactUserPage(user: teacher),
                  ),
                );
              },
...
enum _TeacherSubjectType { help, privateLesson }
...
class _CapabilityChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.teacherIndigo.withValues(alpha: 0.09),
      ...
      child: Row(
        ...
        children: [
          Icon(icon, color: AppColors.skyBlue, size: 15),
...
class _TeacherSubject extends StatelessWidget {
  ...
  const _TeacherSubject({required this.subject, required this.type});

  @override
  Widget build(BuildContext context) {
    final bool help = type == _TeacherSubjectType.help;
