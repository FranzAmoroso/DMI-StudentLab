...
class _TeacherSocialFormState
  ...
  final List<_TeacherAssignmentData>
      _assignments = [];

  bool get _hasSelectedSubjects =>
      _assignments.any((item) => item.selectedSubject != null);
  ...
  void _resetAssignments() {
    for (
      final _TeacherAssignmentData item
      in _assignments
    ) {
  ...
  Future<void> _continue() async {
    ...
    final List<TeacherAssignmentDraft>
        teacherAssignments =
        [];
    ...
    if (_assignments.isNotEmpty) {
      ...
      final String assignmentKey =
          '${selectedSubject.id}:${offering?.id ?? 'all'}';

      if (
        usedAssignments.contains(
          assignmentKey,
        )
      ) {
        _showMessage(
                ...
                child:
                  ...
                  child:
                    ...
                    children: [
                      ...
                      Text(
                        'Crea il tuo account StudentLab, indica i tuoi percorsi e titoli accademici e specifica gli insegnamenti che svolgi.',
                      ...
                      Text(
                        'Seleziona il contesto accademico da cui caricare le materie. Questa scelta serve solo a cercare gli insegnamenti e non aggiunge automaticamente un percorso al profilo.',
                        style:
                            TextStyle(
                          color:
                              AppColors.pureWhite
                      ...
                      if (_subjectsError != null) ...[
                        ...
                        Text(
                          '${_availableSubjects.length} materie disponibili.',
                      ...
                      Text(
                        'Indica le materie che insegni. Se la materia è divisa in moduli o canali puoi specificare anche l\'offering.',
      ...
      child:
        ...
        children: [
          ...
          if (
            ...
            DropdownButtonFormField<
              ...
              decoration:
                ...
                hint:
                    'Tutta la materia oppure un modulo/canale',
          ...
          SwitchListTile(
            ...
            subtitle:
                Text(
              'Disattivalo se si tratta di un insegnamento passato.',
          ...
          SwitchListTile(
            ...
            subtitle:
                Text(
              'Gli utenti potranno richiederti lezioni private su questa materia.',
          ...
          TextFormField(
            ...
            decoration:
              ...
              hint:
                  'Es. Ricevimento, esercitazioni, argomenti specifici...',
      ...
      child:
        ...
        children: [
          ...
          if (
            ...
            Text(
              'Docenti nel catalogo: ${offering.teachers.map((AcademicTeacher teacher) => teacher.name).join(', ')}',
