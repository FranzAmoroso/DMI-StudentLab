...
import 'admin_material_storage_page.dart';
...
class _AdminPanelPageState extends State<AdminPanelPage> {
  ...
  bool get _isCreator =>
      _currentUserRole?.trim().toLowerCase() == 'creator';
  ...
  Future<void> _verifyAccess() async {
    ...
    try {
      final bool authorized = await _apiService.canAccessAdminPanel();
  ...
  Future<void> _openDeveloperArea() async {
    ...
    if (!_isCreator) {
      _showMessage(
        'Solo il creator può accedere alla sezione Developer & System dal pannello amministrativo.',
      );
      return;
    }
  ...
  void _showPending(String feature) {
    _showMessage(
      '$feature richiede ancora il collegamento degli endpoint dedicati nel backend.',
    );
  }
    ...
    return _AdminGrid(
      children: [
        _AdminModuleCard(
          ...
          title: 'Pubblica news',
          description:
              'Crea una comunicazione pubblica con target accademico.',
        ...
        _AdminModuleCard(
          ...
          onTap: () {
            _openProtectedPage(
              const AdminMaterialStoragePage(),
            );
          },
        ),
        _AdminModuleCard(
        ...
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'La migrazione controllata dello storage',
          ),
          pending: true,
        ),
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'La pagina audit delle operazioni sui materiali',
          ),
          pending: true,
        ),
      ],
    ...
    return _AdminGrid(
      children: [
        ...
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'La gestione globale delle segnalazioni gruppi',
          ),
          pending: true,
        ),
        _AdminModuleCard(
        ...
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'La coda unificata delle segnalazioni contenuti',
          ),
          pending: true,
        ),
      ],
    ...
    return _AdminGrid(
      children: [
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'La gestione delle sessioni di assistenza remota',
          ),
          pending: true,
        ),
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'La diagnostica SQLite remota autorizzata',
          ),
          pending: true,
        ),
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'Le azioni remote controllate di assistenza',
          ),
          pending: true,
        ),
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'Lo storico delle sessioni di assistenza',
          ),
          pending: true,
        ),
      ],
    ...
    return _AdminGrid(
      children: [
        ...
        _AdminModuleCard(
          ...
          onTap: () => _showPending(
            'L’audit amministrativo generale',
          ),
          pending: true,
        ),
      ],
