...
super.initState();
  ...
  Future<void> _verifyAccess() async {
    ...
    try {
      ...
      final bool authorized = isDeveloper || await _apiService.canAccessAdminPanel();
      if (!mounted) return;
      setState(() {
  ...
  Future<void> _openProtectedPage(Widget page) async {
    try {
      final bool authorized = _isDeveloperSystem || await _apiService.canAccessAdminPanel();
      if (!mounted) return;
      if (!authorized) {
        setState(() {
          _authorized = false;
        ...
        _AdminModuleCard(
          ...
          onTap: () {
            ...
            _openProtectedPage(
              ...
              const AdminSupportSessionsPage(),
