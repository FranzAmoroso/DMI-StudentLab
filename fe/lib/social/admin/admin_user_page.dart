...
class _AdminUsersPageState
  ...
  Future<void> _toggleUserStatus(
    ...
    if (
      ...
      _showMessage(
        'Non puoi disabilitare il tuo account da questa pagina.',
      );
        ...
        return AlertDialog(
          ...
          content:
            ...
            newStatus
                ...
                : 'Vuoi disabilitare l\'account di ${user.name}? L\'utente non dovrà poter utilizzare le funzionalità riservate agli account attivi.',
    ...
    return Padding(
      ...
      child:
        ...
        decoration:
            InputDecoration(
          hintText:
              'Cerca per nome, email, corso, materia...',
...
class _AdminUserCard
  ...
  Widget build(
    ...
    final SocialAcademicPath? path =
        user.primaryAcademicPath ??
            user.currentAcademicPath;
...
class _UserRoleBadge
    extends StatelessWidget {
  final bool teacher;


  const _UserRoleBadge({
...
class _TeacherVerificationBadge
    extends StatelessWidget {
  final TeacherVerificationStatus
      status;


  const _TeacherVerificationBadge({
